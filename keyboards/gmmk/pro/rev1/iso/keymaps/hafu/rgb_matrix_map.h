 ...
 * Copyright 2021 Hannes Fuchs (hafu) - minor adjustments
 *
...
// #if defined(RGB_MATRIX_ENABLE) || defined(RGB_MATRIX_CUSTOM_EFFECT_IMPLS)
#ifdef RGB_MATRIX_ENABLE

// RGB LED locations
// NOTE: ISO slightly changes (67, 94 and 95)
...
const uint8_t LED_LIST_NUMPAD_EXTRAS[] = {
    LED_0, LED_MINS, LED_EQL,
    LED_P, LED_LBRC, LED_RBRC,
    LED_SCLN, LED_ENT,
    LED_SLSH
};

const uint8_t LED_LIST_FN0_KEYS[] = {
    LED_F3, LED_F4, LED_F7, LED_F8, LED_F9, LED_F10, LED_F11, LED_F12, LED_PSCR,
    LED_DEL,
    LED_P, LED_LBRC, LED_RBRC, LED_PGUP,
    LED_G, LED_SCLN, LED_QUOT, LED_NUHS, LED_PGDN,
    LED_N, LED_UP,
